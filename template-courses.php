...
<div id="page-content" class="container">
	...
	<div id="courses-container">
			...
			<?php wp_reset_query(); ?>
				...
				<?php
				$args = array( 'post_type' => 'training_courses', 'orderby'=> 'meta_value', 'order'=>'ASC', 'posts_per_page' => -1);
				$lastposts = get_posts( $args );
				$i = 1;
				foreach($lastposts as $post) : setup_postdata($post);
				?>

				<div id="<?php echo $i; ?>" class="course-container col-lg-3 col-md-3 col-sm-6">
				...
				<div id="modal-<?php echo $i; ?>" class="course-modal-container container">

					<a href="#" class="close-course">Close <img src="<?php echo get_template_directory_uri(); ?>/assets/img/gold-close.png" alt="Close" title="Close"></a>

					<div class="course-modal-container-inner">
							...
							<div class="course-times">
								...
								?>		
									...
									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">
										...
										<p><?php the_sub_field('course_dates_date'); ?></p>

									</div>

									<div class="col-lg-4 col-md-4 col-sm-4 col-xs-6">

										<p><?php the_sub_field('course_dates_time'); ?></p>
