...
<div id="home-events" class="home-section">
	...
	<div class="container">
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			...
			<?php
			$args = array( 'post_type' => 'post', 'orderby'=> 'date', 'order'=>'DESC', 'posts_per_page' => 3, 'category_name' => 'features');
		...
		<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
			...
			$args = array( 'post_type' => 'post', 'orderby'=> 'date', 'order'=>'DESC', 'posts_per_page' => 3, 'category' => -$cat_id);
			$lastposts = get_posts( $args );
			foreach($lastposts as $post) : setup_postdata($post);
			?>
